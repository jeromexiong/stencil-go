...
import (
	...
	"stencil-go/app/extend/util/timeUtil"
)
...
// rhs 覆盖 lhs
func Merge(lhs interface{}, rhs interface{}) interface{} {
	c := lhs
	...
	for i := 0; i < elem.NumField(); i++ {
		if t1.Field(i).Name == t2.Field(i).Name && !IsBlank(v2.Field(i)) {
			elem.Field(i).Set(v2.Field(i))
		}
	}
	return c
}
